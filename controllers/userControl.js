                ...
                async function queryDB() {
                    ...
                    try{
                        ...
                        await connection.query(`
                            UPDATE staff SET confirmationToken = '${confirmationToken}', confirmed = 'false'
                            WHERE email = '${email}'
                            `)
                        ...
                        if (roleID === 2){
                            ...
                            await connection.query(`
                            INSERT INTO permissions(permitID, staffID, permitItemID) VALUES('2', LAST_INSERT_ID(), '1'),
                            ('1', LAST_INSERT_ID(), '2'), ('1', LAST_INSERT_ID(), '5'), ('1', LAST_INSERT_ID(), '6'),
                        ...
                        if (roleID === '5') {
                            await connection.query(`
                            INSERT INTO permissions(permitID, staffID, permitItemID) VALUES('2', LAST_INSERT_ID(), '2'),
